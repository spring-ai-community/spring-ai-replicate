...
import org.springaicommunity.replicate.api.ReplicateApi.PredictionRequest;
import org.springaicommunity.replicate.api.ReplicateApi.PredictionResponse;
...
public class ReplicateMediaModel {
	...
	public MediaResponse generate(ReplicateOptions options) {
		...
		PredictionResponse predictionResponse = this.replicateApi.createPrediction(
