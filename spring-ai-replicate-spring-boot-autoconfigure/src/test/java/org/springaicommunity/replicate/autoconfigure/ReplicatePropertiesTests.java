...
import org.springaicommunity.replicate.ReplicateChatOptions;
import org.springaicommunity.replicate.ReplicateOptions;
...
class ReplicatePropertiesTests {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
		.withConfiguration(AutoConfigurations.of(ReplicateAutoconfiguration.class));
